...
const Verification = () => {
    ...
    useEffect(() => {
        APIRequest({
            method: 'post',
            url: 'api/Register/EmailTokenVerification/',
            data: {
                Token: verifToken,
                role: "buyer"
            }
                ...
                <Row style={{ height: "100vh" }} className="justify-content-center align-items-center">
                    ...
                    <Col md={5} style={{ marginTop: "0px" }} className="text-center">
                        ...
                        <div className="text-primary mt-5">
                            ...
                            <p className="fs-5">Silahkan Login di halaman <Link to="/login" className="fw-bold text-primary" style={{ textDecoration: "none" }}>Login</Link></p>
                        </div>) : 
